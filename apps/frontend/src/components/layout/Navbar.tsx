  ...
  return (
    <motion.nav
      ...
      className={`sticky top-0 z-50 transition-all duration-300 ${
        scrolled ? 'shadow-lg shadow-black/20 border-b border-white/5' : 'border-b border-white/5'
      }`}
      style={{
          ...
          <div className="flex items-center gap-3">
            {!isAuthenticated && (
              <>
                ...
                <Link
                  href="/signup"
                  className="hidden sm:block px-4 py-2 text-sm font-bold text-white rounded-lg transition-all"
              ...
              {!isAuthenticated && (
                <div className="flex gap-3 pb-3 mb-2 border-b border-slate-800">
                  <Link
                    ...
                    className="flex-1 text-center px-4 py-2.5 text-sm font-medium text-slate-300 border border-slate-700 rounded-lg hover:text-white hover:border-slate-600 transition-colors"
                  >
                    Log In
                  </Link>
                  <Link
                    href="/signup"
                    onClick={() => setMobileMenuOpen(false)}
                    className="flex-1 text-center px-4 py-2.5 text-sm font-bold text-white rounded-lg"
                    style={{ background: '#dc2626' }}
                  >
                    Sign Up
                  </Link>
