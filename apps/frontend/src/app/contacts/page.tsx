      ...
      <div className="p-4 sm:p-6 md:p-8">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="text-center space-y-2 animate-fade-in">
            ...
            <h1 className="text-2xl sm:text-3xl font-black gradient-text">Emergency Contacts</h1>
                ...
                <div className="flex flex-wrap gap-3">
                  <label className="flex items-center gap-2 px-4 py-2 bg-slate-900/50 border border-slate-600 rounded-xl cursor-pointer hover:border-green-500/50 transition-colors">
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, notifyWhatsapp: e.target.checked })
                      }
          ...
          <div className="space-y-3 stagger">
            <h2 className="text-lg font-bold text-slate-300">Your Contacts ({contacts.length})</h2>
