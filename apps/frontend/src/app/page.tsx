...
export default function Home() {
  return (
    <div className="min-h-screen" style={{ background: '#0f172a' }}>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <p className="text-base lg:text-lg leading-relaxed" style={{ color: '#94a3b8' }}>
              Advanced AI listens for distress signals, analyzes emotional stress patterns, and
              automatically alerts your trusted contacts when you need help most.
            </p>
              ...
              <div className="relative space-y-5">
                ...
                >
                  ...
                  >
                    <div
                      ...
                      style={{ width: '98%', background: '#dc2626' }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    <div
                      key={i}
                      className="p-3 rounded-lg text-center border border-white/5"
                      style={{ background: 'rgba(255, 255, 255, 0.02)' }}
                    >
                      <div className="text-xl font-black" style={{ color: '#f1f5f9' }}>
                        {stat.value}
                      </div>
                      <div
          ...
          {[
            {
              ...
              desc: 'Monitors audio for emergency wake phrases with minimal battery impact',
            },
            {
              icon: Icons.brain,
              title: 'AI Analysis',
              desc: 'Gemini AI analyzes emotional stress and distress patterns in real-time',
            },
            {
              icon: Icons.clock,
              title: 'Smart Countdown',
              desc: '10-second verification window to prevent false alarms',
            },
            {
              icon: Icons.alert,
              title: 'Instant Alert',
              desc: 'Notifies trusted contacts with GPS location automatically',
            },
          ].map((feature, index) => (
            <div
              key={index}
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 text-center">
            {[
              ...
              <div
                ...
                style={{ animationDelay: `${index * 100}ms` }}
              >
                <div className="flex justify-center mb-2" style={{ color: '#dc2626' }}>
                  {stat.icon}
                </div>
                <div className="text-2xl sm:text-3xl lg:text-4xl font-black gradient-text">
                  {stat.value}
                </div>
                <div className="text-xs sm:text-sm font-medium" style={{ color: '#94a3b8' }}>
                  {stat.label}
                </div>
              </div>
            ))}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 lg:py-24">
        <div
          className="rounded-2xl p-8 sm:p-10 lg:p-14 text-center relative overflow-hidden"
          style={{ background: '#dc2626' }}
        >
          <div
          ...
          <div className="relative z-10 space-y-5">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
              <Link
                href="/signup"
                className="btn bg-white text-red-600 hover:bg-red-50 font-bold text-center"
              >
                Sign Up Free
              </Link>
              <Link
      ...
      <footer className="max-w-7xl mx-auto px-4 sm:px-6 py-10 border-t border-white/5">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          {[
            ...
            <div key={index}>
              <h3 className="text-sm font-bold mb-3" style={{ color: '#f1f5f9' }}>
                {column.title}
              </h3>
