  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden" style={{ background: '#0f172a' }}>
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -left-40 w-80 h-80 rounded-full blur-3xl opacity-5" style={{ background: '#dc2626' }} />
        <div className="absolute -bottom-40 -right-40 w-80 h-80 rounded-full blur-3xl opacity-5" style={{ background: '#dc2626' }} />
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="card p-8 animate-fade-in">
          <div className="text-center mb-6">
            ...
            <p className="text-sm" style={{ color: '#94a3b8' }}>Start protecting yourself with AI-powered emergency response</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500">{Icons.user}</span>
                <input
                  type="text"
                  required
            ...
            {/* Phone */}
            <div>
              <label className="block text-sm font-medium mb-1.5" style={{ color: '#94a3b8' }}>Phone Number</label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500">{Icons.phone}</span>
                <input
                  type="tel"
                  required
                  className="w-full pl-11 pr-4 py-2.5 rounded-xl text-sm outline-none transition-all focus:ring-2 focus:ring-red-500/50"
            ...
            <div>
              <div className="flex items-start gap-2">
                ...
                <label htmlFor="agreeToTerms" className="text-sm" style={{ color: '#94a3b8' }}>
                  I agree to the{' '}
                  <Link href="/terms" className="text-red-400 hover:text-red-300 transition-colors">Terms</Link>
                  {' '}and{' '}
          ...
          <div className="mt-6 pt-6" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div key={feature} className="flex items-center gap-2 text-xs" style={{ color: '#94a3b8' }}>
