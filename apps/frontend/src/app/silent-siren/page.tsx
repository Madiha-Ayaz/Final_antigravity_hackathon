...
export default function SilentSirenPage() {
      ...
      if (data.success && data.analysis) {
        ...
        if (newLog.emergencyDetected) {
          ...
          try {
            ...
            addAlertLog({
              message: dispatchData.success
                ? 'WhatsApp alert sent via TextMeBot'
  ...
  const handleSendEmergencyMessage = async (
    ...
    try {
      ...
      addAlertLog({
        message: success
          ? 'WhatsApp Alert sent successfully via TextMeBot'
    ...
    <>
      ...
      <div className="min-h-screen bg-slate-950 text-white">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
          ...
          <div
            className="absolute bottom-[-10%] right-[-10%] w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] bg-purple-600 rounded-full blur-[120px] animate-pulse"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs">
                  Voice Monitoring + AI Analysis + WhatsApp Alerts
                </p>
              </div>
            </div>
            ...
            <section className="lg:col-span-2 bg-slate-900/40 border border-slate-800/60 rounded-2xl p-4 sm:p-6 backdrop-blur-md space-y-4">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                <h2 className="text-lg font-bold flex items-center gap-2">
                  <span
                    className={`w-2 h-2 rounded-full ${isActive ? 'bg-red-500 animate-ping' : 'bg-slate-500'}`}
                  />
                  Live Audio Analyzer
                </h2>
                {isActive && (
            ...
            <section className="bg-slate-900/40 border border-slate-800/60 rounded-2xl p-4 sm:p-6 backdrop-blur-md">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center p-3 bg-slate-950/40 border border-slate-800/50 rounded-xl">
                  ...
                  <span
                    className={`px-3 py-1 rounded-lg text-xs font-bold flex items-center gap-1 ${isActive ? 'bg-emerald-500/20 text-emerald-400' : 'bg-slate-800 text-slate-400'}`}
                  >
                ...
                <div className="flex justify-between items-center p-3 bg-slate-950/40 border border-slate-800/50 rounded-xl">
                  ...
                  <span
                    className={`px-3 py-1 rounded-lg text-xs font-bold flex items-center gap-1 ${location ? 'bg-green-500/20 text-green-400' : 'bg-yellow-500/20 text-yellow-400'}`}
                  >
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                ...
                <div className="p-3 bg-gradient-to-br from-red-600/20 to-orange-600/20 rounded-xl border border-red-500/20 text-center">
                  <div className="text-2xl font-black text-red-400">
                    {analysisLogs.filter((l) => l.emergencyDetected).length}
                  </div>
            ...
            <div className="flex border-b border-slate-800">
              {[
                ...
                >
                  ...
                  {tab.count > 0 && (
                    <span className="px-1.5 py-0.5 text-[10px] font-bold bg-slate-700 rounded-full">
                      {tab.count}
                    </span>
                  )}
                </button>
                  ...
                  {isAnalyzing && (
                    <div className="flex items-center gap-3 p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl">
                      ...
                      <span className="text-sm text-blue-300">
                        Gemini analyzing 10s audio segment...
                      </span>
                    </div>
                  )}
